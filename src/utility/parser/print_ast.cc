...
inline void print_integer_expression(donsus_ast::integer_expr &num_expr, int indent_level) {
...
inline void print_string_expression(donsus_ast::string_expr &string_expr,
    ...
    print_with_newline("kind: " +
                          std::string(string_expr.value.type_name()),
                       indent_level);
...
inline void print_identifier(donsus_ast::identifier &identifier, int indent_level) {
    print_with_newline("identifier_name: " + identifier.identifier_name,
                       indent_level);
}

inline void print_assignment(donsus_ast::assignment &assignment, int indent_level) {
    ...
    print_with_newline("identifier_op: " +
                           std::string(assignment.op.type_name()),
                       indent_level);
...
inline void print_type(donsus_ast::donsus_node_type type, int indent_level) {
    print_with_newline("type: " + de_get_from_donsus_node_type(type),
                       indent_level);
}
...
inline void print_function_def(donsus_ast::function_def &f_def, int indent_level) {
    print_with_newline("return_types: ", indent_level);
...
inline void print_statement(donsus_ast::if_statement &statement, int indent_level) {
    print_with_newline("body: ", indent_level);
...
inline void print_expression(donsus_ast::expression &expression, int indent_level) {
...
inline void print_array_decl(donsus_ast::array_decl &decl, int indent_level) {
    print_with_newline("identifier_type: " + std::string(token::type_name(decl.type)),
                       indent_level);
...
inline void print_array_def(donsus_ast::array_def &def, int indent_level) {
    print_with_newline("identifier_type: " + std::string(token::type_name(def.type)),
                       indent_level);
...
inline void print_ast_node(utility::handle<donsus_ast::node> ast_node,
    ...
    case type::DONSUS_INTEGER_EXPRESSION: {
      print_type(ast_node->type, indent_level);
